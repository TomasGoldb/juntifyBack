-- Script final para crear la tabla y función de tracking de ubicación
-- Esta versión maneja correctamente las políticas de PostgreSQL
...
-- Crear políticas (PostgreSQL no soporta IF NOT EXISTS en CREATE POLICY)

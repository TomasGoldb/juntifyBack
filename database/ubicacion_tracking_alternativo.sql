-- Versión alternativa del script de tracking de ubicación
-- Esta versión no depende de tablas específicas hasta que verifiquemos qué tablas existen
...
CREATE TABLE IF NOT EXISTS "UbicacionParticipante" (
  ...
  "idPlan" INTEGER NOT NULL, -- Removemos la referencia por ahora
  "idPerfil" INTEGER NOT NULL, -- Removemos la referencia por ahora
